...
public class Program
{
    public async static Task<int> Main(string[] args)
    {
        try
        {
            ...
            await builder.AddApplicationAsync<AdministrationServiceHttpApiHostModule>(options => options.ApplicationName = GlobalConstants.Services.AdministrationServiceName);
        ...
        {
            Log.Fatal(ex, $"{GlobalConstants.Services.AdministrationServiceName} terminated unexpectedly!");
            return 1;
        }
        finally
        {
