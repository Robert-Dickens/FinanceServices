...
[DependsOn(
    ...
    typeof(FinanceServicesServiceApplicationTestModule),
    typeof(FinanceServicesServiceHttpApiModule)
    )]
public class FinanceServicesServiceHttpApiTestModule : PlatformModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        PreConfigure<AspNetCoreMvcOptions>(options =>
        {
            options.ConventionalControllers.Create(typeof(FinanceServicesServiceApplicationModule).Assembly, opts =>
            {
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddHttpClientProxies(typeof(FinanceServicesServiceHttpApiTestModule).Assembly);
