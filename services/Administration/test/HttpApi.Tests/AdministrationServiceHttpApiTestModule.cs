...
public class AdministrationServiceHttpApiTestModule : PlatformModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddHttpClientProxies(typeof(AdministrationServiceHttpApiTestModule).Assembly);
