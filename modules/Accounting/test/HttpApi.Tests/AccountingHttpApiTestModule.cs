...
public class AccountingHttpApiTestModule : PlatformModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        PreConfigure<AspNetCoreMvcOptions>(options =>
        {
            options.ConventionalControllers.Create(typeof(AccountingApplicationModule).Assembly, opts =>
            {
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddHttpClientProxies(typeof(AccountingHttpApiTestModule).Assembly);
